...
path = Path('scripts/arc.py')
text = path.read_text(encoding='utf-8')

replacement = r'''def generated_readme(owner: str, repo: dict[str, Any], navigation: dict[str, str]) -> str:
